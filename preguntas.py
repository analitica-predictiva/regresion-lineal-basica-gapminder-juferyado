...
def pregunta_02():
    ...
    df = pd.read_csv("https://raw.githubusercontent.com/analitica-predictiva/regresion-lineal-basica-gapminder-DiegoAlexUNALMED/main/gm_2008_region.csv")
...
def pregunta_03():
    ...
    y_life = np.reshape(y_life, (len(y_life),1))
    X_fertility = np.reshape(X_fertility, (len(X_fertility),1))
